...
plt.legend()
prob_df.to_csv(f'{current_path}/../../output/train_pred_lgb1.csv',index=False)
test['TARGET'] = sub_preds
test[['SK_ID_CURR', 'TARGET']].to_csv(f'{current_path}/../../output/test_pred_lgb1.csv', index=False, float_format='%.8f')
